    ...
    <div className="min-h-screen bg-ivory text-royal-navy font-sans">
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-12">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-royal-navy">Welcome back,</h1>
              ...
              <div className="relative z-10">
                ...
                {!isPremium && (
                  <form action="/api/stripe/create-checkout" method="POST">
                    <button type="submit" className="w-full bg-royal-gold text-white font-bold py-4 rounded-2xl hover:bg-royal-gold-light transition-all shadow-lg shadow-royal-gold/20 transform hover:-translate-y-0.5">
                      Upgrade to Pro
                    </button>
                  </form>
                )}
